...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const shineStyle = {
    ...
    filter: 'brightness(0.5) contrast(1.1) saturate(0.2) opacity(0.95)',
      ...
      <div ref={shellRef} className="relative z-1 group">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="absolute inset-0 w-full h-full object-cover -bottom-0.5 will-change-transform transition-transform duration-150 ease-out"
                src={avatarUrl}
            ...
            >
              <div className="w-full absolute flex flex-col top-3">
                <h3
                  className="font-bold drop-shadow-[0_4px_20px_rgba(0,0,0,0.9)]"
                  style={{
